...
def evaluate(text: str, model, tokenizer) -> SummarizationScore:
    ...
    return SummarizationScore(text, joined_summary, statistics.mean(rouge2_recalls), statistics.mean(rouge2_precisions))
...
def evaluate_dataset(
    ...
    return SummarizationDatasetResult(result, statistics.mean(rouge2_recalls), statistics.mean(rouge2_precisions))
...
def calculate_rogue(text: str, summary: str) -> SummarizationScore:
    ...
    return SummarizationScore(text, summary, rouge_2_recall=rouge_2["r"], rouge_2_precision=rouge_2["p"])
